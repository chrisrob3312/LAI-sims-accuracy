...
parser.add_argument("alleles", help="file containing binary-coded alleles", type=argparse.FileType("r"))
parser.add_argument("classes", help="file containing ancestry of haplotypes in alleles file", type=argparse.FileType("r"))
parser.add_argument("snp_locations", help="file containing genetic coordinates of snps in alleles file", type=argparse.FileType("r"))
...
opts = vars(args)
options = {k : opts[k] for k in opts if k in list(argDict.keys()) and opts[k] not in [None, False]}
